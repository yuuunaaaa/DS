...
public class 배열과컬렉션변환3 {
	...
	public static void main(String[] args) {
		...
		// 배열을 가지고 하면 복잡한 처리가 있으면 list로하면 편하다
		// 검색, 수정, 인덱스의 작업을 하려면 asList()를 사용하면 됨
		// asList()로 하면 실제로는 우너본 배열을 가지고 처리하는 것이기 때문에
		// 길이와 관련된 추가, 삭제, 삽입이 불가능
		// 추가, 삭제, 삽입의 작업을 하시려면 모든 기능을 가진 ArrayList를 새로 만들면 됨
